	...
	def download_xml_report(self, report_type):
		...
		try:
			...
			if report_type is "Monthly":
				...
				print('{} is not a valid report_type. Choose Monthly or Daily!'.format(report_type))
			
			# Select for page to show all results
			select_all_entries = Select(browser.find_element_by_id('Paging_ResultsForPage'))
...
if __name__ == "__main__":
	acc = Account("/home/mike/code/home_sheets", acc)
	acc.connect()
